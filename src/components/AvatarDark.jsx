...
Command: npx gltfjsx@6.2.10 public/models/avatar-dark.glb -k
*/

import React, { useRef, useEffect } from 'react'
import { useAnimations, useFBX, useGLTF } from '@react-three/drei'

export function AvatarDark(props) {
  const groupRef = useRef()
  const { nodes, materials } = useGLTF('models/avatar-dark.glb')
...
useGLTF.preload('models/avatar-dark.glb')
